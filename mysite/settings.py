...
load_dotenv(os.path.join(BASE_DIR, 'lab', '.env'))
...
SECRET_KEY = 'django-insecure-(k(t^ydt9@=n41$dy+fxael2+1n_h*ea=k+s3kzb9i#8bk#(0&'
...
MEDIA_URL = 'media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'lab', 'media', 'lab', 'uploads')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'lab.context_processors.baseurl',
            ],
        },
    },
]
